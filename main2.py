...
def detectVL(
    ...
    for i in data[1:]:
        ...
        matrix[a][b] = 255
    # ///////////////////////////
    # B3, 3.1 Detect line, check trong từng cụm dữ liệu có tồn tại VL marker không
    # ///////////////////////////
    ...
    if len(list_lines_out):
        ...
        if _show == True:
            ...
            cv2.imwrite(r"C:/Users/xuanhieuktsx/data_marker/result.jpg", B3_image)
            cv2.imshow("B3.2,3", B3_2_3_image)
            cv2.imwrite(r"C:/Users/xuanhieuktsx/data_marker/result1.jpg", B3_2_3_image)
            cv2.imshow("B4", out_image)
            cv2.imwrite(r"C:/Users/xuanhieuktsx/data_marker/result2.jpg", out_image)
            cv2.imshow("origin", matrix)
            cv2.imwrite(r"C:/Users/xuanhieuktsx/data_marker/origin.jpg", matrix)
            cv2.waitKey(500)
...
if __name__ == "__main__":
    path = r"C:/Users/xuanhieuktsx/data_marker/data/vl/"
